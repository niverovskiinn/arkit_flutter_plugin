...
import 'package:arkit_plugin/src/geometries/material/arkit_blend_mode.dart';
import 'package:arkit_plugin/src/geometries/material/arkit_color_mask.dart';
import 'package:arkit_plugin/src/geometries/material/arkit_cull_mode.dart';
import 'package:arkit_plugin/src/geometries/material/arkit_fill_mode.dart';
import 'package:arkit_plugin/src/geometries/material/arkit_lighting_model.dart';
import 'package:arkit_plugin/src/geometries/material/arkit_material.dart';
import 'package:arkit_plugin/src/geometries/material/arkit_material_property.dart';
import 'package:arkit_plugin/src/geometries/material/arkit_transparency_mode.dart';
import 'package:arkit_plugin/src/hit/arkit_hit_test_result_type.dart';
import 'package:arkit_plugin/src/light/arkit_light_type.dart';
import 'package:arkit_plugin/src/physics/arkit_physics_body_type.dart';
import 'package:arkit_plugin/src/physics/arkit_physics_shape.dart';
...
class ListMaterialsValueNotifierConverter
  ...
  ValueNotifier<List<ARKitMaterial>?> fromJson(List<Map>? json) {
    ...
    return ValueNotifier(json
        ...
        .map((e) => ARKitMaterial.fromJson(e)) as List<ARKitMaterial>);
  }
...
class MapOfMatrixConverter
    implements JsonConverter<Map<String, Matrix4>, Map<dynamic, dynamic>> {
  const MapOfMatrixConverter();

  @override
  Map<String, Matrix4> fromJson(Map<dynamic, dynamic> json) {
...
class Vector3ValueNotifierConverter
  ...
  ValueNotifier<Vector3> fromJson(List<dynamic>? json) {
    return ValueNotifier(
        Vector3.fromFloat64List(json!.cast<double>() as Float64List));
  }
...
class Vector4ValueNotifierConverter
  ...
  ValueNotifier<Vector4> fromJson(List<dynamic>? json) {
    return ValueNotifier(
        Vector4.fromFloat64List(json!.cast<double>() as Float64List));
  }
